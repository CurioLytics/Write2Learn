...
import { HighlightSelector } from '@/app/journal/components/highlight-selector-new';
import { HighlightList } from '@/app/journal/components/journal/editor/highlight-list';
import styles from '@/app/journal/components/highlight-selector.module.css';
