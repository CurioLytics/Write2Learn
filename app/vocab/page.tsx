          ...
          <>
            ...
            <div className="mb-6 flex items-center justify-between">
              <h2 className="text-lg font-medium text-gray-800">
                Your Vocabulary Sets {showStarredOnly && '⭐'}
              </h2>
              <button
                ...
                title={showStarredOnly ? 'Show all sets' : 'Show only starred sets'}
              >
          ...
          <>
            ...
            <div className="mb-6">
              ...
              {isLoadingStarredWords ? (
                <div className="text-center py-8 text-gray-500">Loading starred words...</div>
              ) : starredWords.length === 0 ? (
                <div className="text-center py-12 text-gray-500">
                  <p className="mb-2">No starred words yet</p>
                  <p className="text-sm">Star some words in your vocabulary sets to see them here!</p>
                </div>
              ) : (
